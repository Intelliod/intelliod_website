...
const Popup = ({ isOpen, onClose, videoSrc, content }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center  bg-opacity-50 mt-10">
      <div className=" p-6 rounded-xl shadow-lg items-center bg-neutral-800 text-white md:flex gap-10 space-y-5 mx-3 h-[80%] max-w-[80%] mx-auto my-auto overflow-y-scroll scrollbar-hide" ref={popupRef}>
        <div>
        {hasError ? (
