          ...
          <div className="flex flex-col justify-center items-start order-2 lg:order-2">
            ...
            >
              <span className='text-xl md:text-3xl lg:text-5xl font-semibold'>
                What is a <span className='bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text'>Digital Twin</span>
              </span>
            </motion.h1>
            <motion.p
              id="about-content"
            ...
            <motion.p
              className='mt-5 text-xl border border-transparent hover:border-white px-2 py-1 rounded-lg cursor-pointer bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text'
              // onClick={togglePopup}
            >
