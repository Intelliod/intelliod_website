...
const Product5 = () => {
  ...
  return (
    <div className="relative border-neutral-800 min-h-[600px]  ">
      <Navbar />
      <div className=''>
        <div className="h-[500px] md:h-[600px] lg:h-[700px] text-center px-3 flex flex-col justify-center items-center ">
          <h1 className="text-5xl md:text-6xl lg:text-8xl py-10 font-bold mt-10 bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text w-[80%] text-center py-5 mx-auto">AADHYA - AI-powered Organizational GPT</h1>
      ...
      <div className="text-center">
        <span className="text-5xl bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text">
          Key Feature
        </span>
