    ...
    <div className="relative border-neutral-800 min-h-[600px]  ">
      ...
      <div className=''>
        <div className="h-[400px] md:h-[500px] lg:h-[600px] flex flex-col justify-center items-center  px-3">
          <h1 className="text-5xl md:text-6xl lg:text-8xl text-center font-bold mt-10 bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text py-10">Telecom Tower Reconstruction</h1>
        ...
        {features.map((feature, index) => (
          <div key={index} className="w-full">
            <div className="flex">
              ...
              <div>
                <h5 className="mt-1 mb-2 text-2xl font-semibold text-white">{feature.text}</h5>
