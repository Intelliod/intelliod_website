...
const features = [
  ...
  return (
    <div className="relative border-neutral-800 text-white">
      <Navbar />
      <div className=''>
        <div className="h-[400px] md:h-[500px] lg:h-[600px] flex flex-col justify-center items-center px-3">
          <h1 className="text-5xl md:text-6xl lg:text-8xl text-center font-bold mt-10 bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text py-10">Smart City Planning 
          </h1>
          <p className='text-lg md:text-xl lg:text-3xl text-center'>Intelligent Urban Planning for Sustainable and Adaptive Growth</p>

        </div>
        <div className='w-[80%] mx-auto py-5'>
          <img src="https://mbs-data-bucket.s3.ap-south-1.amazonaws.com/website/images/Mbs_main/solutions/city_planning/smart_city.png" alt="bg" className="lg:w-[80%] mx-auto rounded-lg object-cover" />
        </div>
      </div>

      <div className="relative mt-20 border-neutral-800 py-10 max-w-7xl mx-auto">
      <div className="text-center">
        <span className="text-4xl lg:text-5xl bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text">
          Key Feature
        </span>
      ...
      <div className="grid md:grid-cols-3 gap-10 mt-10 lg:mt-20 pb-10 px-2">
        {features.map((feature, index) => (
          <div key={index} className="w-full">
            <div className="flex">
              <div className="flex mx-6 h-14 w-14 px-4 bg-[#007fff] text-white text-lg lg:text-xl justify-center items-center rounded-lg">
                {feature.icon}
              </div>
              <div>
                <h5 className="mt-1 mb-2 text-xl lg:text-2xl font-semibold">{feature.text}</h5>
