...
const Product4 = () => {
  ...
  return (
    <div className="relative border-neutral-800 min-h-[600px]  ">
      <Navbar />
      <div className=''>
        <div className="h-[400px] md:h-[500px] lg:h-[600px] text-center px-3 flex flex-col justify-center items-center ">
          <h1 className="text-5xl md:text-6xl lg:text-8xl py-10 font-bold mt-10 bg-gradient-to-r from-[#0038a8] to-white text-transparent bg-clip-text py-5">Intelligence FOD Tracker</h1>
